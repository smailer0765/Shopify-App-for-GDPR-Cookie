	...
	<div class="row">
		<div class="col-md-12">
			<div class="card card-tasks">
				...
				<form class="form-horizontal" role="form" method="post" action="<?=base_url();?>cookies_group/update_cookies_group/<?=$group['id'] ?>" id="cookies_group" enctype="multipart/form-data">
