		...
		<div class="col-md-12">
			<div class="card  card-tasks">
				...
				<div class="table-header row">
					...
					<div class="col-md-2">
						<a href="<?=base_url(); ?>cookies_group/add_cookies_group" class="btn btn-primary" >Add Cookies Group</a>
					</div>					
				</div>
...
<script type="text/javascript">
	...
	function getTable()
	{
		table = $('#cookies_group_table').dataTable({
			...
			"bInfo":false,
			"aaSorting": [[ 0, "desc" ]],
			"sAjaxSource": "<?php echo base_url(); ?>cookies_group/get_cookies_group",
