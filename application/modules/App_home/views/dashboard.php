				...
				<div class="Polaris-Layout__Section">
					<div class="Polaris-Card">
						...
						<div class="Polaris-Card__Section">
							...
							<p>To set app bar,<a href="/app_home/setting/stagebit.myshopify.com"> CLICK HERE TO SET COOKIE BAR </a></p>
						</div>
						<div class="Polaris-Card__Section">
						...
						<div class="Polaris-Card__Section">
							...
							<p>To set Cookie Group,<a href="/app_cookies_group/dashboard/stagebit.myshopify.com"> CLICK HERE TO SET COOKIE GROUP </a></p>
						</div>
						<div class="Polaris-Card__Section">
							<h3 aria-label="Reports" class="Polaris-Heading">How to set Cookies?</h3>
							<p>To set Cookies,<a href="/app_cookies/dashboard/stagebit.myshopify.com"> CLICK HERE TO SET COOKIES </a></p>
						</div>
					</div>
				</div>
			</div>
