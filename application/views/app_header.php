...
<div id="navbar" class="navbar navbar-default">
    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a href="<?php echo base_url(); ?>app_home/dashboard/<?=$shop?>" class="navbar-brand"> <small> <i class="fa fa-leaf"></i> Advanced GDPR EU Cookie Bar Setup </small> </a> <!-- <?php //echo ucfirst($logedin['check_user']); ?> Panel  -->
        </div>
		<input type="hidden" id="domain" name="domain" value="<?=$shop;?>" />
