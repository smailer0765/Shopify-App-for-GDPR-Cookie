...
<div class="footer">
  <div class="footer-inner">
    <div class="footer-content"> <span class="bigger-120"> <span class="blue bolder">Advanced GDPR EU Cookie Bar Admin Panel</span></span> </div>
  </div>
</div>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/dataTables.colVis.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/custom-js.js?<?=rand(0,999)?>"></script>
